...
const CaseManagerSelectionPage = () => {
  ...
  const renderExitPlanForm = () => {
    return (
      <Form form={exitPlanForm} name="exitPlanForm" onFinish={saveExitPlan}>
        ...
        <Form.Item
          name="resources"
          label="Resources, Referrals, and Prescriptions"
        >
          <Input.TextArea rows={4} />
        </Form.Item>
        <Form.Item>
  ...
  const renderGeneralAccountView = () => {
    if (selectedMenuItem === "viewGeneralAccount" && selectedCaseManager) {
      return (
        <div>
          <h2>
            General Account View for {selectedCaseManager.name}'s Patients:
          </h2>
          <p>
            <strong>Social:</strong> Active in community events and volunteers
            at a local shelter.
          </p>
          <p>
            <strong>Family:</strong> Lives with a partner and three children,
            all attending school.
          </p>
          <p>
            <strong>Health History:</strong> No significant health issues,
            maintains a balanced diet and exercise routine.
          </p>
          <p>
            <strong>Clinical Quality Management Measures:</strong> All clinical
            quality measures are within normal ranges.
          </p>
          <p>
            <strong>General View Item:</strong> Some additional information
            relevant to the patient's general account.
          </p>
        </div>
      );
    }
      ...
      const patientsData = [
        {
          ...
          "Progress and Outcomes":
            "Improved mobility and communication skills.",
        },
        {
          ID: "P002",
          Name: "Bob Smith",
          ...
          "Progress and Outcomes":
            "Improved mobility and independent living skills.",
        },
        ...
        <div>
          ...
          {patientsData.map((patient, index) => (
            ...
            >
              ...
              <p>
                <strong>Patient's Age:</strong> {patient.Age} years
              </p>
              <p>
              ...
              <p>
                ...
                {patient["Type of Disability"]}
              </p>
              <p>
                <strong>Case Manager ID:</strong> {patient["Case Manager ID"]}
              </p>
              <p>
                <strong>Case Manager Name:</strong>{" "}
                {patient["Case Manager Name"]}
              </p>
              <p>
                <strong>Case Manager's Assigned Patients:</strong>{" "}
                {patient["Case Manager's Assigned Patients"].join(", ")}
              </p>
              <p>
                <strong>Case Manager Contact Information:</strong>{" "}
                {patient["Case Manager Contact Information"]}
              </p>
              <p>
                <strong>Care Given Service Type:</strong>{" "}
                {patient["Care Given Service Type"]}
              </p>
              <p>
                <strong>Frequency and Duration of Services:</strong>{" "}
                {patient["Frequency and Duration of Services"]}
              </p>
              <p>
                <strong>Progress and Outcomes:</strong>{" "}
    ...
    if (selectedMenuItem === "viewDemographics" && selectedCaseManager) {
      return (
        <div>
          ...
          <p>
            <strong>Age:</strong> 38 years
          </p>
          <p>
            <strong>City:</strong> Anytown
          </p>
          <p>
            <strong>Race:</strong> Caucasian
          </p>
          <p>
            <strong>VerifiedByDocuments:</strong> True
          </p>
          <p>
            <strong>MaritalStatus:</strong> Married
          </p>
          <p>
            <strong>EmploymentStatus:</strong> Employed
          </p>
          <p>
            <strong>EducationLevel:</strong> Bachelor's Degree
          </p>
          <p>
            <strong>HealthcareInformation:</strong> Regular check-ups
          </p>
          <p>
            <strong>MedicalHistory:</strong> No significant issues
          </p>
          <p>
            <strong>DiagnosedFor:</strong> Normal
          </p>
          <p>...</p>
          <p>...</p>
          <p>
            <strong>Services Incurred:</strong> None
          </p>
          <p>
            <strong>ServiceRequestID:</strong> 98765
          </p>
        </div>
      );
    }
  ...
  return (
    <div>
      ...
      <Modal
        title={`Case Manager: ${
          selectedCaseManager ? selectedCaseManager.name : ""
        }`}
